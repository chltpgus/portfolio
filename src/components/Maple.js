    ...
    return (
        <div>
            ...
            <div className="description_text">
                <p className="description_text_p">메이플 호감도 사이트는 메이플에서 호불호가 갈리는 캐릭터 얼굴의 호감도를 확인할 수 있는 테스트 사이트입니다.</p>
            </div>
            ...
            <div className="description_contribution">
                ...
                <li className="description_contribution_li">테스트를 완료한 인원수 저장 (기여도 100%)</li>
                <p className="description_contribution_p2">사이트를 접속하면 get 요청으로 현재까지 완료한 인원수를 가져와서 저장</p>
                <p className="description_contribution_p2">테스트를 마치고 결과 확인 버튼을 누르면 get 요청으로 받은 값에 1을 더해 post 전송으로 값 저장</p>
